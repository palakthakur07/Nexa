// Adapted from a shadcn-style community component (originally .tsx) — this
// project uses plain JS/JSX, and the component has no real dependency on
// TypeScript or shadcn conventions (no cn(), no Radix, no cva), so it was
// ported directly rather than converting the whole project to TS.
//
// `src`, if provided, renders a raster image clipped into the laptop
// screen. NEXA's hero instead overlays real product UI on top (see
// hero/NexaScreenPreview.jsx) rather than a stock photo, to stay
// consistent with the rest of the design system.
export function MacbookPro({ width = 650, height = 400, src, style, ...props }) {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      {src && (
        <image
          href={src}
          x="74.52" y="21.32" width="501.22" height="323.85"
          preserveAspectRatio="xMidYMid slice"
          clipPath="url(#nexa-macbook-rounded-corners)"
        />
      )}
      ...
      <defs>
        <clipPath id="nexa-macbook-rounded-corners">
