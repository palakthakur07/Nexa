...
import NexaChatPreview from "./NexaChatPreview.jsx";
import { Reveal, useCameraParallax } from "../../lib/hooks.jsx";

// Laptop-mockup hero. Screen content is a real animated NEXA chat
// transcript (NexaChatPreview), rendered as an HTML overlay positioned with
// percentages matched to MacbookPro's screen cutout, not a stock photo.
const FEATURES = [
